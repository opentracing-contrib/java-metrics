...
@SpringBootTest(
        classes = {WebTracingConfigurationBeanPostProcessorNoPropertyTest.SpringConfiguration.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class WebTracingConfigurationBeanPostProcessorNoPropertyTest {
    ...
    @Test
    public void testUnmodifiedSkipPattern() {
        assertEquals("/test", webTracingConfig.getSkipPattern().pattern());
    }
